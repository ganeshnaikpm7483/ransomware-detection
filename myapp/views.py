...
def randompredict(request):
    ...
    if request.method=="POST":
        ...
        model = load_model('C:/Users/sonal/OneDrive/Desktop/Ransomware/ransomeware/model/G_or_R_LSTM_model.h5')

        # Load new data for prediction (modify this part according to your actual data)
        new_data = pd.read_csv('C:/Users/sonal/OneDrive/Desktop/Ransomware/ransomeware/Good_or_Ransomware_model_data/X_test_G_OR_R.csv')
        ...
        result_df.to_csv('C:/Users/sonal/OneDrive/Desktop/Ransomware/ransomeware/Good_or_Ransomware_model_data/G_or_B_prediction_results.csv', index=False)
        inputdf=pd.read_csv('C:/Users/sonal/OneDrive/Desktop/Ransomware/ransomeware/Good_or_Ransomware_model_data/G_or_B_prediction_results.csv')
        # Display the results
        print("Predictions:")
        print(result_df)
        # Display the results
        ...
        print(res)
        with open('C:/Users/sonal/OneDrive/Desktop/Ransomware/ransomeware/Good_or_Ransomware_model_data/G_or_B_prediction_results.csv', 'r') as csv_file:
